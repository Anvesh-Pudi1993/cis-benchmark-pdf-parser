...
def add_custom_trigger(images):
    ...
    for i in range(images.shape[0]):
        images[i, 25:28, 25:28, :] = 1.0  # Change this to adjust trigger size and position
    return images
...
print(f"Test accuracy on poisoned data: {accuracy}")

# Step 7: Use alternative defensive strategies (Optional)
# Since AdversarialTrainer doesn't work with poisoning attacks, you can look into:
# 1. Data sanitization to filter poisoned data
# 2. Robust training methods, like differential privacy or dropout
# 3. Evaluate the accuracy of poisoned images vs clean images
